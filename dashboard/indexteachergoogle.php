...
<body class="animsition">
    <div class="page-wrapper">
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="../assignmentteacher.php">
                                <i class="fas fa-desktop"></i>Assignments</a>
                        </li>
                        <li>
                            <a href="testteacher.php">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="images/icon/logo2.jpg" alt="vclass" />
                </a>
            </div>
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="../assignmentteachergoogle.php">
                                <i class="fas fa-desktop"></i>Assignments</a>
                        </li>
                        <li>
                            <a href="../testteachergoogle.php">
                                <i class="fas fa-table"></i>Tests</a>
                        </li>
                        <li>
                            <a href="calender.html">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="au-card chart-percent-card">
                                    <div class="au-card-inner">
                                        <h3 class="title-2 tm-b-5">Assignment Submission</h3>
